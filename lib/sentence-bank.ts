...
function c(text: string): Word {
  return { text, contraction: true };
}
function w(text: string): Word {
  return { text, contraction: false };
}

// Pronouns
export const pronouns: Word[] = [w('I'), c('you'), w('he'), w('she'), w('we'), c('it'), w('they')];
...
// Determiners
export const determiners: Word[] = [c('the'), w('a'), c('his'), c('every'), c('that'), c('more')];
...
export const frames: SentenceFrame[] = [
  ...
  { wordCount: 3, slots: [pick(pronounSubj), pick(verbsBase, (v) => v.contraction), pick(nouns)] },
  ...
  { wordCount: 4, slots: [pick(pronounSubj), pick(verbsBase, (v) => v.contraction), detThe, pick(nouns)] },
  ...
  {
    wordCount: 4,
    slots: [pick(pronounSingular), c('was'), pick([c('quite'), c('very'), c('so'), c('rather')]), pick(adjectives)],
  },
  ...
  { wordCount: 4, slots: [c('people'), pick(verbsBase, (v) => v.contraction), detThe, pick(nouns)] },
  ...
  {
    wordCount: 5,
    slots: [pick(pronounSubj), pick(verbsBase, (v) => v.contraction), detThe, pick(adjectives), pick(nouns)],
  },
  ...
  {
    wordCount: 5,
    slots: [pick(pronounPlural), c('were'), c('not'), pick([c('so'), c('very'), c('quite')]), pick(adjectives)],
  },
  ...
  {
    wordCount: 5,
    slots: [c('knowledge'), w('is'), pick([c('quite'), c('very'), c('rather')]), pick(adjectives), pick(nouns)],
  },
  ...
  {
    wordCount: 6,
    slots: [pick(detSimple), pick(adjectives), pick(nouns), pick(verbsPast), pick(prepositions), pick(nouns)],
  },
  ...
  {
    wordCount: 7,
    slots: [pick(pronounSubj), pick(modals), c('not'), pick(verbsBase), pick(prepositions), detThe, pick(nouns)],
  },
  ...
  {
    wordCount: 7,
    slots: [pick(pronounSubj), c('have'), c('just'), detThe, pick(nouns), pick(prepositions), pick(pronouns)],
  },
];
